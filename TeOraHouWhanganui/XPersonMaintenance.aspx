<%@ Page Title="TOHW Person Maintenance" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="XPersonMaintenance.aspx.cs" Inherits="TeOraHouWhanganui.PersonMaintenance" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#search').click(function () {
                window.location.href = "<%=ResolveUrl("~/personsearch.aspx")%>";
            });
