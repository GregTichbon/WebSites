    ...
    <div class="container">
        ...
        <div id="tabs">
            ...
            <div id="div_home">
                ...
                <h2>WHANGANUI'S VERY OWN YOUTH LED<br />RANGATAHI TALENT QUEST</h2>
                <br />
                ...
                Cost: <strong>$2.00 entrance fee, Water - $2.00 and a sausage sizzle - $2.00</strong><br />
                <br />
                All profit is going to KidsCan<br />
                <br />
                Catch us on
                <a href="https://www.instagram.com/cntrvibe" target="_blank">Instagram</a> and <a href="https://www.facebook.com/groups/830801327843382" target="_blank">Facebook</a>
                <br />
                <br />
            ...
            <div id="div_kidscan">
                ...
                <h2>KidsCan</h2>
                <p>We are proud to be supporting <strong>KidsCan</strong> by donating all of the proceeds from door sales and water and the sausage sizzle sales.</p>
            ...
            <div id="div_registration" class="form-horizontal" style="position: relative;">
                ...
                <div id="div_group" style="display: none">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="fld_groupnumber">Number of people in group 
                        </label>
                        <div class="col-sm-8">
                    ...
                    <div class="col-sm-4"></div>
                    <div class="col-sm-8"><label class="control-label">Contact Person</label></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="fld_emailaddress" name="fld_emailaddress" class="form-control" required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-4" for="fld_confirmemailaddress">Please confirm your email address</label>
                    <div class="col-sm-8">
                        <input type="text" id="fld_confirmemailaddress" class="form-control" required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-4" for="fld_contact">
                        <img class="helpicon" src="_Dependencies/Images/qm.png" title="What are the best ways to get hold of you? eg: Phone number(s), Other email addresses, Messenger apps etc." />
                        Other Contact details</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4" for="fld_description"><img class="helpicon" src="_Dependencies/Images/qm.png" title="Please provide as much information as possible eg: Type of performance, style etc." />
                        Description</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4" for="fld_requirements">
                        <img class="helpicon" src="_Dependencies/Images/qm.png" title="Please provide as much information as possible eg: Stage area, number of microphones, power for amps, keyboards etc." />
                        Requirements</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4" for="fld_uploads">
                        <img class="helpicon" src="_Dependencies/Images/qm.png" title="These may be useful for better understanding your act and may be used in publicity." />
                        Photos</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div style="float: left; width: 50px;">
                            <input id="fld_declaration" name="fld_declaration" class="form-control" type="checkbox" required="required" />
                        </div>
                ...
                <div class="form-group">
                    <div class="col-sm-4"></div>
                    <div class="col-sm-8">
                        <input type="submit" id="btn_submit" class="btn btn-info" value="Submit" />
                    </div>
                </div>
            </div>
        </div>
